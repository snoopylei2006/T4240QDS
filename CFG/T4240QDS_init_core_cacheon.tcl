...
proc init_platform {} {
	...
	if {$processor_revision == 1} {
		...
		mem [CCSR_ADDR 0x10104] = 0x00000000
		# CPC1_CPCEWCR0 - disable stashing
		mem [CCSR_ADDR 0x10010] = 0x00000000
		# CPC1_CPCERRDIS 
		mem [CCSR_ADDR 0x10E44] = 0x000000EB
		# CPC1_CPCCSR0 - invalidate(CPCFI) and No flash lock clear(CPCLFC)
		mem [CCSR_ADDR 0x10000] = 0x00200400
		wait 500
		# CPC1_CPCCSR0 - enable L3 cache
		mem [CCSR_ADDR 0x10000] = 0x80000000
	} else {
		...
		# Configure internal CPC2 as L3 cache
		# CPC2_CPCSRCR0  - SRBARL=0, INTLVEN=0, SRAMSZ=0, SRAMEN=0
		mem [CCSR_ADDR 0x11104] = 0x00000000
		# CPC2_CPCEWCR0 - disable stashing
		mem [CCSR_ADDR 0x11010] = 0x00000000
		# CPC2_CPCERRDIS 
		mem [CCSR_ADDR 0x11E44] = 0x000000EB
		# CPC2_CPCCSR0 - invalidate(CPCFI) and No flash lock clear(CPCLFC)
		mem [CCSR_ADDR 0x11000] = 0x00200400
		wait 500
		# CPC2_CPCCSR0 - enable L3 cache
		mem [CCSR_ADDR 0x11000] = 0x80000000

		# Configure internal CPC3 as L3 cache
		# CPC3_CPCSRCR0  - SRBARL=0, INTLVEN=0, SRAMSZ=0, SRAMEN=0
		mem [CCSR_ADDR 0x12104] = 0x00000000
		# CPC3_CPCEWCR0 - disable stashing
		mem [CCSR_ADDR 0x12010] = 0x00000000
		# CPC3_CPCERRDIS 
		mem [CCSR_ADDR 0x12E44] = 0x000000EB
		# CPC3_CPCCSR0 - invalidate(CPCFI) and No flash lock clear(CPCLFC)
		mem [CCSR_ADDR 0x12000] = 0x00200400
		wait 500
		# CPC3_CPCCSR0 - enable L3 cache
		mem [CCSR_ADDR 0x12000] = 0x80000000
